...
@login_required
@extend_schema(
    summary="Sync repositories for a workspace",
    description="Fetch repositories from GitHub, reconcile them with the local workspace records, and remove deleted items.",
    responses={
        200: OpenApiResponse(description="Repositories synchronized"),
        500: OpenApiResponse(description="GitHub sync failure"),
    },
)
